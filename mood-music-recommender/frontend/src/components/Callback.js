...
//     if (refreshToken) {
//       axios.post(`${API_URL}/api/spotify/refresh`, { refreshToken })
//         .then(response => {
...
//       axios.post(`${API_URL}/api/spotify/callback`, { code })
//         .then(response => {
//           if (response.data.accessToken) {
//             localStorage.setItem('spotify_token', response.data.accessToken);
...
//   return (
//     <CallbackContainer>
//       {loading ? <p>Authenticating...</p> : error && <p>{error}</p>}
//     </CallbackContainer>
//   );
// }
